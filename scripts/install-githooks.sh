...
echo "  ✅ Auto-format code with Black (backend)"
echo "  ✅ Auto-fix linter issues with Ruff (backend)"
echo "  ✅ Check type safety with MyPy (backend)"
echo "  ✅ Run tests pytest when needed (backend)"
echo "  ✅ Run ESLint and TypeScript checks (frontend)"
echo ""
